    ...
    def execute(self, query, params=None, log_exceptions=None):
        ...
        try:
            ...
            if (getattr(threading.currentThread(), 'testing', False) or
                config.get('test_enable') or not (QUERY_CATCH_VERBOSE and
                (bytes(QUERY_TO_CATCH, encoding='UTF-8') in self._obj.query))):
                return
